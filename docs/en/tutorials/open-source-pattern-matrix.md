...
| Guardrail evidence | Safety checks are invisible or unverifiable | Record validator, verdict, repair attempt, fail-closed decision, matched policy, and owner | [`../production/safety-checklist.md`](../production/safety-checklist.md), [`../../../examples/safety-eval/README.md`](../../../examples/safety-eval/README.md) | Vendor validator catalog |
| Safety eval battery | Safety quality relies on one-off judgment | Maintain versioned tests for injection, refusal, leakage, harm, hallucination, and usability tradeoffs | [`../production/evals-playbook.md`](../production/evals-playbook.md), [`../../../examples/safety-eval/README.md`](../../../examples/safety-eval/README.md) | Toxicity dataset internals |
| Trace dataset loop | Production failures never become eval cases | Convert reviewed traces into datasets, annotations, and eval cases without leaking private raw prompts | [`../production/observability-trace-contract.md`](../production/observability-trace-contract.md), [`../../../examples/agent-eval-regression/README.md`](../../../examples/agent-eval-regression/README.md) | Dashboard annotation UI |
| Memory governance evidence | Memory is used as unexplained truth | Record source, confidence, owner, conflict, update/delete action, and privacy scope before using memory as evidence | [`../concepts/long-term-memory.md`](../concepts/long-term-memory.md), [`../../../examples/memory-vs-evidence/README.md`](../../../examples/memory-vs-evidence/README.md) | Memory provider data model |
| Local model boundary | Private inference paths are undocumented | Record model registry, pull/run command, model id/version, resource limits, network policy, and trace fields | [`../production/cost-stability-operations.md`](../production/cost-stability-operations.md), [`../production/safety-checklist.md`](../production/safety-checklist.md) | Local runtime API guide |
| Experiment evidence | Prompt/model comparisons are anecdotal | Bind changes to run id, parameters, metrics, artifacts, and comparison decision | [`../production/evals-playbook.md`](../production/evals-playbook.md), [`../production/observability-trace-contract.md`](../production/observability-trace-contract.md) | Experiment dashboard screenshot |
| MCP server boundary | External tools are treated as trusted local functions | Record server id, tool name, input schema, permission scope, transport/lifecycle state, result status, and audit actor before execution | [`../skills/tool-mcp-safety.md`](../skills/tool-mcp-safety.md), [`../../../examples/mcp-tool-boundary/README.md`](../../../examples/mcp-tool-boundary/README.md) | Official server implementation |
| Graph state boundary | Multi-step Agent loops hide where state changed | Define state schema, node transitions, checkpoint id, retry count, interrupt owner, and stop condition | [`../concepts/plan-decision-making.md`](../concepts/plan-decision-making.md), [`../../../examples/mcp-tool-boundary/README.md`](../../../examples/mcp-tool-boundary/README.md) | Graph framework DSL |
| Typed tool output | Invalid tool output corrupts downstream state | Validate tool/model output against schema, record validation error, and cap retries before state changes | [`../concepts/agent-system-architecture.md`](../concepts/agent-system-architecture.md), [`../production/evals-playbook.md`](../production/evals-playbook.md) | SDK-specific Pydantic code |
| RAG pipeline boundary | Retrieval quality cannot be diagnosed | Keep ingestion, retrieval, ranking, reranking, citation, and answer policy as separate evidence points | [`../l3-rag-memory-observability.md`](../l3-rag-memory-observability.md), [`../production/evals-playbook.md`](../production/evals-playbook.md) | Vector-store-specific schema |
| Browser action trace | UI actions are invisible and hard to roll back | Record visible context, action intent, DOM or screenshot summary, retry budget, and rollback note | [`../concepts/implementation-guide.md`](../concepts/implementation-guide.md), [`../production/safety-checklist.md`](../production/safety-checklist.md) | Browser automation internals |
