...
| Practice multilingual routing and fallback | [`examples/multilingual-support/README.md`](../../../examples/multilingual-support/README.md) | A routing log covering supported languages, low-confidence fallback, and refusal |
| Practice evidence-gated approvals | [`examples/compliance-review/README.md`](../../../examples/compliance-review/README.md) | An approval log linking evidence completeness, approver role, and audit trail |
...
| Try the Vibe Coding workflow | [`../vibe-coding/README.md`](../vibe-coding/README.md) -> [`../../../labs/l5/vibe_coding_spec/README.md`](../../../labs/l5/vibe_coding_spec/README.md) | A one-sentence spec, a reviewed diff, and a green acceptance check for a small Lab or example change |
