...
```text
agent-top/
├── .github/       CI 工作流、Issue 模板、标签、PR 模板
├── docs/          双语知识库（en + zh），按主题组织
├── docs-site/     静态文档站点入口
├── examples/      无需 API key 的练习材料（JSONL 证据 + README）
├── labs/          可执行、确定性的 L0-L5 练习
├── scripts/       本地校验与自动化工具
├── templates/     可复用贡献与评审模板
├── package.json / requirements.txt / pyproject.toml
└── README.md + 治理、安全与路线图文档
```

每个顶层目录都有各自的入口：

- [`docs/en/README.md`](docs/en/README.md) 与 [`docs/zh/README.md`](docs/zh/README.md) 组织双语文档。
- [`labs/README.md`](labs/README.md) 按能力等级列出每个可执行 Lab；`labs/l0`-`labs/l5` 各有入口 README。
- [`examples/README.md`](examples/README.md) 说明证据文件示例集。
- `scripts/`、`templates/` 与 `.github/` 分别集中存放工具、模板与 CI。
...
- 评估报告模板：[`templates/评估报告模板.md`](templates/评估报告模板.md)
- 复盘模板：[`templates/复盘模板.md`](templates/复盘模板.md)
...
- 多语言支持示例：[`examples/multilingual-support/README.md`](examples/multilingual-support/README.md)
- 合规评审示例：[`examples/compliance-review/README.md`](examples/compliance-review/README.md)
