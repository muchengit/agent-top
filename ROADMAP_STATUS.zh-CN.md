...
| 任务优先入口 | Done | `docs/en/tutorials/quick-navigation.md`、`docs/zh/tutorials/快速导航卡.md`、`examples/README.md`、`examples/agent-decision-trace/`、`examples/rag-evidence-refusal/`、`examples/memory-vs-evidence/` |
...
| 开源模式矩阵 | Done | `docs/en/tutorials/open-source-pattern-matrix.md`、中文镜像和 `examples/memory-vs-evidence/` |
