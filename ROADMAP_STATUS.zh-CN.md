...
| 生产指南 | Done | `docs/en/production/`、成本稳定性运行手册、评估与回归 Playbook、可观测性与 Trace 契约、生产速查表、`examples/observability-trace/`, including runtime evidence |
