...
- Eval report template: [`templates/eval-report-template.md`](templates/eval-report-template.md)
...
- Multilingual support example: [`examples/multilingual-support/README.md`](examples/multilingual-support/README.md)
- Compliance review example: [`examples/compliance-review/README.md`](examples/compliance-review/README.md)
...
- Vibe Coding guide: [`docs/en/vibe-coding/README.md`](docs/en/vibe-coding/README.md) with [`labs/l5/vibe_coding_spec/README.md`](labs/l5/vibe_coding_spec/README.md) and [`templates/vibe-coding-spec-template.md`](templates/vibe-coding-spec-template.md)
